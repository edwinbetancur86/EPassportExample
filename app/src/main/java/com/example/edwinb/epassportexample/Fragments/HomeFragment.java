...
public class HomeFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        CardView cardViewNewPre = (CardView) view.findViewById(R.id.prescriptionDrugsCard);
        cardViewNewPre.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Animation animation = AnimationUtils.loadAnimation(view.getContext(), android.R.anim.fade_in);
                view.startAnimation(animation);

                Intent intent = new Intent(view.getContext(), NewPrescriptionActivity.class);
